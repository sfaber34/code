pro lwcVcdplwcMfssplwc
  ...
  p1=scatterplot(fssplwc,cdplwc-fssplwc,dimensions=[1600,1200],symbol='.',margin=50,/device)
  p40=plot([min,max],[0,0],/overplot,'green',thick=2)
